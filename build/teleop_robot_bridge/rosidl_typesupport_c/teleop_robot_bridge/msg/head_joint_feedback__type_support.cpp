...
static const _HeadJointFeedback_type_support_symbol_names_t _HeadJointFeedback_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, teleop_robot_bridge, msg, HeadJointFeedback)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, teleop_robot_bridge, msg, HeadJointFeedback)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, teleop_robot_bridge, msg, HeadJointFeedback)() {
  return &::teleop_robot_bridge::msg::rosidl_typesupport_c::HeadJointFeedback_message_type_support_handle;
}
