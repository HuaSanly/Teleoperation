...
class Metaclass_AgvImu(type):
    """Metaclass of message 'AgvImu'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'teleop_robot_bridge.msg.AgvImu')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__agv_imu
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__agv_imu
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__agv_imu
            cls._TYPE_SUPPORT = module.type_support_msg__msg__agv_imu
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__agv_imu
...
class AgvImu(metaclass=Metaclass_AgvImu):
    """Message class 'AgvImu'."""
    ...
    def __init__(self, **kwargs):
        ...
        from sensor_msgs.msg import MagneticField
        self.magnetic_field = kwargs.get('magnetic_field', MagneticField())
    ...
    def magnetic_field(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'magnetic_field' field must be a sub message of type 'MagneticField'"
