...
class Metaclass_WaistTcpCommand(type):
    """Metaclass of message 'WaistTcpCommand'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'teleop_robot_bridge.msg.WaistTcpCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__waist_tcp_command
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__waist_tcp_command
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__waist_tcp_command
            cls._TYPE_SUPPORT = module.type_support_msg__msg__waist_tcp_command
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__waist_tcp_command
...
class WaistTcpCommand(metaclass=Metaclass_WaistTcpCommand):
    """Message class 'WaistTcpCommand'."""
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.UnboundedString(), 1),  # noqa: E501
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'name' field must be a set or sequence with length 1 and each value of type 'str'"
        self._name = value
