...
bool teleop_robot_bridge__msg__arm_joint_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("teleop_robot_bridge.msg._arm_joint_status.ArmJointStatus", full_classname_dest, 56) == 0);
  }
  teleop_robot_bridge__msg__ArmJointStatus * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ArmJointStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("teleop_robot_bridge.msg._arm_joint_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArmJointStatus");
