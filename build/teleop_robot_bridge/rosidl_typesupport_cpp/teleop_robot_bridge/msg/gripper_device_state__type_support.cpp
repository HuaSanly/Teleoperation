...
static const _GripperDeviceState_type_support_symbol_names_t _GripperDeviceState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_robot_bridge, msg, GripperDeviceState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, teleop_robot_bridge, msg, GripperDeviceState)),
  }
};
...
{
  return &::teleop_robot_bridge::msg::rosidl_typesupport_cpp::GripperDeviceState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, teleop_robot_bridge, msg, GripperDeviceState)() {
  return get_message_type_support_handle<teleop_robot_bridge::msg::GripperDeviceState>();
}
