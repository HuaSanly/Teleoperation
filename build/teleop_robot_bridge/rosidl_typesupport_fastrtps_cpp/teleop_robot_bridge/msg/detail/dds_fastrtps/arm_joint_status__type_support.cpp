...
#include "teleop_robot_bridge/msg/detail/arm_joint_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = teleop_robot_bridge::msg::ArmJointStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const teleop_robot_bridge::msg::ArmJointStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<teleop_robot_bridge::msg::ArmJointStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ArmJointStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const teleop_robot_bridge::msg::ArmJointStatus *>(
...
static size_t _ArmJointStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ArmJointStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ArmJointStatus__callbacks = {
...
static rosidl_message_type_support_t _ArmJointStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ArmJointStatus__callbacks,
...
{
  return &teleop_robot_bridge::msg::typesupport_fastrtps_cpp::_ArmJointStatus__handle;
}
