...
#include "teleop_robot_bridge/msg/detail/head_joint_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const teleop_robot_bridge::msg::HeadJointStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  teleop_robot_bridge::msg::HeadJointStatus & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_teleop_robot_bridge
max_serialized_size_HeadJointStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = teleop_robot_bridge::msg::HeadJointStatus;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_teleop_robot_bridge
max_serialized_size_key_HeadJointStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const teleop_robot_bridge::msg::HeadJointStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<teleop_robot_bridge::msg::HeadJointStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HeadJointStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const teleop_robot_bridge::msg::HeadJointStatus *>(
...
static size_t _HeadJointStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HeadJointStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HeadJointStatus__callbacks = {
...
static rosidl_message_type_support_t _HeadJointStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HeadJointStatus__callbacks,
...
{
  return &teleop_robot_bridge::msg::typesupport_fastrtps_cpp::_HeadJointStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_robot_bridge, msg, HeadJointStatus)() {
  return &teleop_robot_bridge::msg::typesupport_fastrtps_cpp::_HeadJointStatus__handle;
}
