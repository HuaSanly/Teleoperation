...
#include "teleop_robot_bridge/msg/detail/gripper_move__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const teleop_robot_bridge::msg::SingleGripperMove &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const teleop_robot_bridge::msg::GripperMove & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  teleop_robot_bridge::msg::GripperMove & ros_message)
{
  // Member: header
  ...
  // Member: grippers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.grippers[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: grippers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        teleop_robot_bridge::msg::typesupport_fastrtps_cpp::max_serialized_size_SingleGripperMove(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = teleop_robot_bridge::msg::GripperMove;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_teleop_robot_bridge
max_serialized_size_key_GripperMove(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: grippers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        teleop_robot_bridge::msg::typesupport_fastrtps_cpp::max_serialized_size_key_SingleGripperMove(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const teleop_robot_bridge::msg::GripperMove *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<teleop_robot_bridge::msg::GripperMove *>(
    untyped_ros_message);
...
{
  return &teleop_robot_bridge::msg::typesupport_fastrtps_cpp::_GripperMove__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_robot_bridge, msg, GripperMove)() {
  return &teleop_robot_bridge::msg::typesupport_fastrtps_cpp::_GripperMove__handle;
}
