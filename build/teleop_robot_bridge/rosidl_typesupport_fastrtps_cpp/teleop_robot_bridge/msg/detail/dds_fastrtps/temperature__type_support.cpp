...
#include "teleop_robot_bridge/msg/detail/temperature__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const teleop_robot_bridge::msg::Temperature & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  teleop_robot_bridge::msg::Temperature & ros_message)
{
  // Member: temperature
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = teleop_robot_bridge::msg::Temperature;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: temperature
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sensor_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Temperature(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const teleop_robot_bridge::msg::Temperature *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<teleop_robot_bridge::msg::Temperature *>(
    untyped_ros_message);
...
{
  return &teleop_robot_bridge::msg::typesupport_fastrtps_cpp::_Temperature__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_robot_bridge, msg, Temperature)() {
  return &teleop_robot_bridge::msg::typesupport_fastrtps_cpp::_Temperature__handle;
}
