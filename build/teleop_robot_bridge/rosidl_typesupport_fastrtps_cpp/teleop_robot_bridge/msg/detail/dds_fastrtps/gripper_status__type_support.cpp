...
#include "teleop_robot_bridge/msg/detail/gripper_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const teleop_robot_bridge::msg::SingleGripperStatus &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const teleop_robot_bridge::msg::GripperStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  teleop_robot_bridge::msg::GripperStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: grippers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        teleop_robot_bridge::msg::typesupport_fastrtps_cpp::max_serialized_size_SingleGripperStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = teleop_robot_bridge::msg::GripperStatus;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: grippers
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        teleop_robot_bridge::msg::typesupport_fastrtps_cpp::max_serialized_size_key_SingleGripperStatus(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const teleop_robot_bridge::msg::GripperStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<teleop_robot_bridge::msg::GripperStatus *>(
    untyped_ros_message);
...
{
  return &teleop_robot_bridge::msg::typesupport_fastrtps_cpp::_GripperStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, teleop_robot_bridge, msg, GripperStatus)() {
  return &teleop_robot_bridge::msg::typesupport_fastrtps_cpp::_GripperStatus__handle;
}
