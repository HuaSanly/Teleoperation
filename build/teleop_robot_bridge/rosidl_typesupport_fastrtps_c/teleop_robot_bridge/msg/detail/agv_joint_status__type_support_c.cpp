...
#include "teleop_robot_bridge/msg/detail/agv_joint_status__rosidl_typesupport_fastrtps_c.h"
...
using _AgvJointStatus__ros_msg_type = teleop_robot_bridge__msg__AgvJointStatus;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_teleop_robot_bridge
bool cdr_serialize_teleop_robot_bridge__msg__AgvJointStatus(
  const teleop_robot_bridge__msg__AgvJointStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_teleop_robot_bridge
bool cdr_deserialize_teleop_robot_bridge__msg__AgvJointStatus(
  eprosima::fastcdr::Cdr & cdr,
  teleop_robot_bridge__msg__AgvJointStatus * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_teleop_robot_bridge
size_t get_serialized_size_teleop_robot_bridge__msg__AgvJointStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AgvJointStatus__ros_msg_type * ros_message = static_cast<const _AgvJointStatus__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_teleop_robot_bridge
size_t max_serialized_size_teleop_robot_bridge__msg__AgvJointStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = teleop_robot_bridge__msg__AgvJointStatus;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_teleop_robot_bridge
bool cdr_serialize_key_teleop_robot_bridge__msg__AgvJointStatus(
  const teleop_robot_bridge__msg__AgvJointStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_teleop_robot_bridge
size_t get_serialized_size_key_teleop_robot_bridge__msg__AgvJointStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AgvJointStatus__ros_msg_type * ros_message = static_cast<const _AgvJointStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_teleop_robot_bridge
size_t max_serialized_size_key_teleop_robot_bridge__msg__AgvJointStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const teleop_robot_bridge__msg__AgvJointStatus * ros_message = static_cast<const teleop_robot_bridge__msg__AgvJointStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_teleop_robot_bridge__msg__AgvJointStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  teleop_robot_bridge__msg__AgvJointStatus * ros_message = static_cast<teleop_robot_bridge__msg__AgvJointStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_teleop_robot_bridge__msg__AgvJointStatus(cdr, ros_message);
}

static uint32_t _AgvJointStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_teleop_robot_bridge__msg__AgvJointStatus(
...
static size_t _AgvJointStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_teleop_robot_bridge__msg__AgvJointStatus(
...
static message_type_support_callbacks_t __callbacks_AgvJointStatus = {
...
static rosidl_message_type_support_t _AgvJointStatus__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AgvJointStatus,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, teleop_robot_bridge, msg, AgvJointStatus)() {
  return &_AgvJointStatus__type_support;
}
