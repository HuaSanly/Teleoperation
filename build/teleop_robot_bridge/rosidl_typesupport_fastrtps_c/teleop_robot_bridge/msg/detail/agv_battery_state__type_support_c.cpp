...
#include "teleop_robot_bridge/msg/detail/agv_battery_state__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/detail/battery_state__functions.h"  // battery_state
...
using _AgvBatteryState__ros_msg_type = teleop_robot_bridge__msg__AgvBatteryState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr_serialize_sensor_msgs__msg__BatteryState(
  ...
  teleop_robot_bridge__msg__AgvBatteryState * ros_message)
{
  // Field name: battery_state
  {
    cdr_deserialize_sensor_msgs__msg__BatteryState(cdr, &ros_message->battery_state);
  }
...
size_t get_serialized_size_teleop_robot_bridge__msg__AgvBatteryState(
  ...
  size_t current_alignment)
{
  const _AgvBatteryState__ros_msg_type * ros_message = static_cast<const _AgvBatteryState__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = teleop_robot_bridge__msg__AgvBatteryState;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: battery_state
  {
    cdr_serialize_key_sensor_msgs__msg__BatteryState(
      &ros_message->battery_state, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: battery_state
  current_alignment += get_serialized_size_key_sensor_msgs__msg__BatteryState(
    &(ros_message->battery_state), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: battery_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_sensor_msgs__msg__BatteryState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static bool _AgvBatteryState__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const teleop_robot_bridge__msg__AgvBatteryState * ros_message = static_cast<const teleop_robot_bridge__msg__AgvBatteryState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_teleop_robot_bridge__msg__AgvBatteryState(ros_message, cdr);
}

static bool _AgvBatteryState__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  teleop_robot_bridge__msg__AgvBatteryState * ros_message = static_cast<teleop_robot_bridge__msg__AgvBatteryState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_teleop_robot_bridge__msg__AgvBatteryState(cdr, ros_message);
}

static uint32_t _AgvBatteryState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_teleop_robot_bridge__msg__AgvBatteryState(
      untyped_ros_message, 0));
}

static size_t _AgvBatteryState__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_teleop_robot_bridge__msg__AgvBatteryState(
...
static message_type_support_callbacks_t __callbacks_AgvBatteryState = {
  "teleop_robot_bridge::msg",
  "AgvBatteryState",
  _AgvBatteryState__cdr_serialize,
  _AgvBatteryState__cdr_deserialize,
  _AgvBatteryState__get_serialized_size,
  _AgvBatteryState__max_serialized_size,
  nullptr
};

static rosidl_message_type_support_t _AgvBatteryState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AgvBatteryState,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, teleop_robot_bridge, msg, AgvBatteryState)() {
  return &_AgvBatteryState__type_support;
}
