...
class Metaclass_WaistJointCommand(type):
    """Metaclass of message 'WaistJointCommand'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'teleop_robot_bridge.msg.WaistJointCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__waist_joint_command
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__waist_joint_command
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__waist_joint_command
            cls._TYPE_SUPPORT = module.type_support_msg__msg__waist_joint_command
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__waist_joint_command
...
class WaistJointCommand(metaclass=Metaclass_WaistJointCommand):
    """Message class 'WaistJointCommand'."""
