...
bool teleop_robot_bridge__msg__head_joint_feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("teleop_robot_bridge.msg._head_joint_feedback.HeadJointFeedback", full_classname_dest, 62) == 0);
  }
  teleop_robot_bridge__msg__HeadJointFeedback * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of HeadJointFeedback */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("teleop_robot_bridge.msg._head_joint_feedback");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HeadJointFeedback");
