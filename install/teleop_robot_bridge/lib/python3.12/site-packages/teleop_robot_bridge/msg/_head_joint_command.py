...
class Metaclass_HeadJointCommand(type):
    """Metaclass of message 'HeadJointCommand'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'teleop_robot_bridge.msg.HeadJointCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__head_joint_command
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__head_joint_command
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__head_joint_command
            cls._TYPE_SUPPORT = module.type_support_msg__msg__head_joint_command
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__head_joint_command
...
class HeadJointCommand(metaclass=Metaclass_HeadJointCommand):
    """Message class 'HeadJointCommand'."""
