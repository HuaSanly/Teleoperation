...
bool teleop_robot_bridge__msg__single_device_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("teleop_robot_bridge.msg._single_device_state.SingleDeviceState", full_classname_dest, 62) == 0);
  }
  teleop_robot_bridge__msg__SingleDeviceState * ros_message = _ros_message;
  {  // health_status
  ...
  {  // error_domain
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->error_domain.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'error_domain'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of SingleDeviceState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("teleop_robot_bridge.msg._single_device_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SingleDeviceState");
  ...
  {  // error_domain
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "error_domain");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->error_domain.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->error_domain.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->error_domain.size * sizeof(uint8_t));
      assert(data != NULL);
