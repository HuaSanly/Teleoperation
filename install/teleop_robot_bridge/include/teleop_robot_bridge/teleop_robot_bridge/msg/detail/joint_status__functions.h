...
#ifndef TELEOP_ROBOT_BRIDGE__MSG__DETAIL__JOINT_STATUS__FUNCTIONS_H_
#define TELEOP_ROBOT_BRIDGE__MSG__DETAIL__JOINT_STATUS__FUNCTIONS_H_
 ...
 * )) before or use
 * teleop_robot_bridge__msg__JointStatus__create()
 ...
 * calls
 * teleop_robot_bridge__msg__JointStatus__init().
...
/**
 * It calls
 * teleop_robot_bridge__msg__JointStatus__fini()
 ...
 * teleop_robot_bridge__msg__JointStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * teleop_robot_bridge__msg__JointStatus__Sequence__fini()
 * on the array,
...
#endif  // TELEOP_ROBOT_BRIDGE__MSG__DETAIL__JOINT_STATUS__FUNCTIONS_H_
