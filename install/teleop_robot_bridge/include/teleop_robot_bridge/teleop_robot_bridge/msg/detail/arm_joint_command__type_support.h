...
#ifndef TELEOP_ROBOT_BRIDGE__MSG__DETAIL__ARM_JOINT_COMMAND__TYPE_SUPPORT_H_
#define TELEOP_ROBOT_BRIDGE__MSG__DETAIL__ARM_JOINT_COMMAND__TYPE_SUPPORT_H_
...
#endif  // TELEOP_ROBOT_BRIDGE__MSG__DETAIL__ARM_JOINT_COMMAND__TYPE_SUPPORT_H_
