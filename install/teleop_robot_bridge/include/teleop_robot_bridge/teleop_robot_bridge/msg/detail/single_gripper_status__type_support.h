...
#ifndef TELEOP_ROBOT_BRIDGE__MSG__DETAIL__SINGLE_GRIPPER_STATUS__TYPE_SUPPORT_H_
#define TELEOP_ROBOT_BRIDGE__MSG__DETAIL__SINGLE_GRIPPER_STATUS__TYPE_SUPPORT_H_
...
#endif  // TELEOP_ROBOT_BRIDGE__MSG__DETAIL__SINGLE_GRIPPER_STATUS__TYPE_SUPPORT_H_
