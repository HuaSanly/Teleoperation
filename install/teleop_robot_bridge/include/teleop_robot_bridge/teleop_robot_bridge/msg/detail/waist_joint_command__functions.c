...
teleop_robot_bridge__msg__WaistJointCommand__init(teleop_robot_bridge__msg__WaistJointCommand * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    teleop_robot_bridge__msg__WaistJointCommand__fini(msg);
    return false;
  }
  // name
...
teleop_robot_bridge__msg__WaistJointCommand__create(void)
{
  ...
  teleop_robot_bridge__msg__WaistJointCommand * msg = (teleop_robot_bridge__msg__WaistJointCommand *)allocator.allocate(sizeof(teleop_robot_bridge__msg__WaistJointCommand), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(teleop_robot_bridge__msg__WaistJointCommand));
  bool success = teleop_robot_bridge__msg__WaistJointCommand__init(msg);
  if (!success) {
...
teleop_robot_bridge__msg__WaistJointCommand__Sequence__init(teleop_robot_bridge__msg__WaistJointCommand__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  teleop_robot_bridge__msg__WaistJointCommand * data = NULL;

  if (size) {
    data = (teleop_robot_bridge__msg__WaistJointCommand *)allocator.zero_allocate(size, sizeof(teleop_robot_bridge__msg__WaistJointCommand), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = teleop_robot_bridge__msg__WaistJointCommand__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        teleop_robot_bridge__msg__WaistJointCommand__fini(&data[i - 1]);
      }
...
teleop_robot_bridge__msg__WaistJointCommand__Sequence__fini(teleop_robot_bridge__msg__WaistJointCommand__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      teleop_robot_bridge__msg__WaistJointCommand__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  teleop_robot_bridge__msg__WaistJointCommand__Sequence * array = (teleop_robot_bridge__msg__WaistJointCommand__Sequence *)allocator.allocate(sizeof(teleop_robot_bridge__msg__WaistJointCommand__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = teleop_robot_bridge__msg__WaistJointCommand__Sequence__init(array, size);
  if (!success) {
...
teleop_robot_bridge__msg__WaistJointCommand__Sequence__destroy(teleop_robot_bridge__msg__WaistJointCommand__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    teleop_robot_bridge__msg__WaistJointCommand__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
teleop_robot_bridge__msg__WaistJointCommand__Sequence__are_equal(const teleop_robot_bridge__msg__WaistJointCommand__Sequence * lhs, const teleop_robot_bridge__msg__WaistJointCommand__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!teleop_robot_bridge__msg__WaistJointCommand__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  teleop_robot_bridge__msg__WaistJointCommand__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(teleop_robot_bridge__msg__WaistJointCommand);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    teleop_robot_bridge__msg__WaistJointCommand * data =
      (teleop_robot_bridge__msg__WaistJointCommand *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!teleop_robot_bridge__msg__WaistJointCommand__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          teleop_robot_bridge__msg__WaistJointCommand__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!teleop_robot_bridge__msg__WaistJointCommand__copy(
